...
import { ConditionalStyles, TableColumn, Format, Selector, SortDirection, SortFunction } from './types';
...
export declare function setRowData<T>(rows: T[], selector: Selector<T> | null | undefined, direction: SortDirection, sortServer: boolean, sortFn?: SortFunction<T> | null): T[];
export declare function sort<T>(rows: T[], selector: Selector<T> | string | null | undefined, direction: SortDirection, sortFn?: SortFunction<T> | null): T[];
