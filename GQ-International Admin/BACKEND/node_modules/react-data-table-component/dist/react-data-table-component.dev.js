...
function tableReducer(state, action) {
    ...
    switch (action.type) {
        case 'UPDATE_ROWS': {
            const { rows } = action;
            return Object.assign(Object.assign({}, state), { rows });
        }
        ...
        case 'SELECT_MULTIPLE_ROWS': {
            ...
            return Object.assign(Object.assign({}, state), { selectedCount: selectedRows.length, allSelected: selectedRows.length === rows.length, selectedRows,
        ...
        case 'SORT_CHANGE': {
            ...
            return Object.assign(Object.assign(Object.assign({}, state), { rows,
                selectedColumn,
...
`;
function ExpanderRow({ data, component, componentProps, extendedRowStyle, extendedClassNames, }) {
    ...
    return (React__namespace.createElement(ExpanderRowStyle, { className: classNames, extendedRowStyle: extendedRowStyle },
        React__namespace.createElement(ExpandableComponent, Object.assign({ data: data }, componentProps))));
}
...
function Row({ columns = [], conditionalRowStyles = [], defaultExpanded = false, defaultExpanderDisabled = false, dense = false, expandableIcon, expandableRows = false, expandableRowsComponent, expandableRowsComponentProps, expandableRowsHideExpander, expandOnRowClicked = false, expandOnRowDoubleClicked = false, highlightOnHover = false, id, expandableInheritConditionalStyles, keyField, onRowClicked = noop, onRowDoubleClicked = noop, onRowExpandToggled = noop, onSelectedRow = noop, pointerOnHover = false, row, rowCount, rowIndex, selectableRowDisabled = null, selectableRows = false, selectableRowsComponent, selectableRowsComponentProps, selectableRowsHighlight = false, selectableRowsSingle = false, selected, striped = false, draggingColumnId, onDragStart, onDragOver, onDragEnd, onDragEnter, onDragLeave, }) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        expandableRows && expanded && (React__namespace.createElement(ExpanderRow$1, { key: `expander-${rowKeyField}`, data: row, extendedRowStyle: inheritStyles, extendedClassNames: classNames, component: expandableRowsComponent, componentProps: expandableRowsComponentProps }))));
}
...
const ColumnText = styled__default["default"].div `
	...
	text-overflow: ellipsis;
`;
function TableCol({ rows, column, disabled, draggingColumnId, selectedColumn = {}, sortDirection, sortFunction, sortIcon, sortServer, pagination, paginationServer, persistSelectedOnSort, selectableRowsVisibleOnly, onSort, onDragStart, onDragOver, onDragEnd, onDragEnter, onDragLeave, }) {
    React__namespace.useEffect(() => {
    ...
    const handleSortChange = () => {
        ...
        if (!sortServer) {
            ...
            if (colCustomSortFn) {
                const customSortFunction = direction === 'asc' ? colCustomSortFn : (a, b) => colCustomSortFn(a, b) * -1;
...
function DataTable(props) {
    ...
    const [{ rowsPerPage, rows, currentPage, selectedRows, allSelected, selectedCount, selectedColumn, sortDirection, toggleOnSelectedRowsChange, }, dispatch,] = React__namespace.useReducer(tableReducer, {
    ...
    useFirstUpdate(() => {
        dispatch({
            type: 'UPDATE_ROWS',
            rows: setRowData(data, selectedColumn === null || selectedColumn === void 0 ? void 0 : selectedColumn.selector, sortDirection, sortServer, sortFunction),
        });
    }, [data]);
    React__namespace.useEffect(() => {
